...
for (let i = 0; i < lines.length; i++) {
   if (lines[i].includes('"id": "12 Mah"')) {
       in12mah = true;
   }
   if (in12mah && lines[i].includes('"size": ')) {
       in12mah = false; // logic exit
   }
   if (in12mah && lines[i].includes(`"en": "<div class=\\"premium-desc pd-v3\\">`)) {
       let start = i;
       let end = i;
...
console.log('Successfully updated 12 Mah en richDescription');
