...
for (let i = 0; i < lines.length; i++) {
   if (lines[i].includes('"id": "9 Mah"')) {
       in9mah = true;
   }
   if (in9mah && lines[i].includes('"size": ')) {
       in9mah = false; // logic exit
   }
   if (in9mah && lines[i].includes(`"en": "<div class=\\"premium-desc pd-v3\\">`)) {
       let start = i;
       let end = i;
...
console.log('Successfully updated 9 Mah en richDescription');
