...
for (let i = 0; i < lines.length; i++) {
   if (lines[i].includes('"id": "11 Mah"')) {
       in11mah = true;
   }
   if (in11mah && lines[i].includes('"size": ')) {
       in11mah = false; // logic exit
   }
   if (in11mah && lines[i].includes(`"en": "<div class=\\"premium-desc pd-v3\\">`)) {
       let start = i;
       let end = i;
...
console.log('Successfully updated 11 Mah en richDescription');
