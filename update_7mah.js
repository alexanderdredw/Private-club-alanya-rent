...
for (let i = 0; i < lines.length; i++) {
   if (lines[i].includes('"id": "7 Mah"')) {
       in7mah = true;
   }
   if (in7mah && lines[i].includes('"size": ')) {
       in7mah = false; // logic exit
   }
   if (in7mah && lines[i].includes(`"en": "<div class=\\"premium-desc pd-v3\\">`)) {
       let start = i;
       let end = i;
...
console.log('Successfully updated 7 Mah en richDescription');
