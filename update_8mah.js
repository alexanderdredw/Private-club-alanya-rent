...
for (let i = 0; i < lines.length; i++) {
   if (lines[i].includes('"id": "8 Mah"')) {
       in8mah = true;
   }
   if (in8mah && lines[i].includes('"size": ')) {
       in8mah = false; // logic exit
   }
   if (in8mah && lines[i].includes(`"en": "<div class=\\"premium-desc pd-v3\\">`)) {
       let start = i;
       let end = i;
...
console.log('Successfully updated 8 Mah en richDescription');
